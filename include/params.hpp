...
constexpr uint8_t STOPBOX_TL_X          = 25;       // Top Left corner of the stop detection box - X
constexpr uint8_t STOPBOX_TL_Y          = 80;       // Top Left corner of the stop detection box - Y
constexpr uint8_t STOPBOX_BR_X          = 47;       // Bottom Right corner of the stop detection box - X
constexpr uint8_t STOPBOX_BR_Y          = 94;       // Bottom Right corner of the stop detection box - Y
